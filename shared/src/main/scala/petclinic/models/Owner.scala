...
/** Owner defines what pieces of data an Owner is comprised of. This data type
...
object Owner {
  ...
  /** Uses the random method defined on our OwnerId wrapper to generate a random
    * ID and assign that to the Owner we are creating.
    */
  ...
  /** Generates a JSON codec for the Owner type allowing it to be (de)serialized
    */
